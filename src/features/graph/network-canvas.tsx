    ...
    void import("cytoscape").then(({ default: cytoscape }) => {
      ...
      const graph = cytoscape({
        ...
        style: [
          ...
          { selector: "edge.primary", style: { width: 3.2, "line-color": "#67aaf0", "target-arrow-color": "#67aaf0", opacity: 0.94 } }, { selector: "edge.secondary", style: { width: 2.1, "line-color": "#5f86b5", "target-arrow-color": "#5f86b5", opacity: 0.72 } }, { selector: "edge.tertiary", style: { width: 1.25, "line-style": "dashed", opacity: 0.52 } },
          { selector: "edge.pending", style: { opacity: 0.58 } }, { selector: "edge.changes-requested", style: { "line-style": "dashed", opacity: 0.48 } }, { selector: "edge.rejected", style: { "line-style": "dotted", opacity: 0.32 } }, { selector: "edge.focus-dim", style: { opacity: 0.16 } }, { selector: "edge.neighborhood-edge", style: { opacity: 0.84 } }, { selector: "edge.marker-selected", style: { width: 4.6, "line-color": "#d8ebff", "target-arrow-color": "#d8ebff", opacity: 1 } },
