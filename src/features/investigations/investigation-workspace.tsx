...
interface Finding { id: string; category: string; title: string; detail: string; status: string; supportingRecordIds: string[]; evidence: EvidenceRef[]; verificationLevels: string[]; }
